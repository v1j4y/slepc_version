...
&BEGIN_PROVIDER [integer, xt,(maxlien)]
...
!C  allocate (xjjxy(maxlien))
    ...
    xeneparJ,xenediagJ,xeneperpT,xeneparT,xenediagT,xspar,xsperp
    NAMELIST/infdia/isz,iprec,maxda2,niter,ngao,nvec,numero,nes4, &
    xseuil,ysuiv,yec
